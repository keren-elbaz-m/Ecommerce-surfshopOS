---
description: Extract patterns and conventions from your codebase into documented standards
argument-hint: "[area]"
---
...
4. Create or update the file in `softwareos/standards/[folder]/`
...
1. Scan `softwareos/standards/` for all `.md` files
...
3. Update `softwareos/standards/index.yml`:
...
Ordering: `root` first, then remaining folders alphabetized; files alphabetized within each folder.
...
All standards: `softwareos/standards/[folder]/[standard].md`
Index file: `softwareos/standards/index.yml`
